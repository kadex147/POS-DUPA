...
<div class="flex flex-col lg:flex-row gap-4 lg:gap-6 h-auto lg:h-[calc(100vh-140px)]">
    ...
    <div class="flex-1 flex flex-col bg-white rounded-lg p-4 lg:p-6 order-2 lg:order-1">
        ...
        <div class="mt-4 bg-gray-50 rounded-lg border border-gray-200 px-4 py-3">
            <div class="flex items-center justify-center gap-4">
                ...
                @else
                    <a href="{{ $products->appends(request()->query())->previousPageUrl() }}" class="p-2 hover:bg-gray-100 rounded">
                ...
                @if($products->hasMorePages())
                    <a href="{{ $products->appends(request()->query())->nextPageUrl() }}" class="p-2 hover:bg-gray-100 rounded">
                        <svg class="w-5 h-5 text-gray-600" fill="currentColor" viewBox="0 0 20 20">
