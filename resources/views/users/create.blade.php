...
<div class="max-w-4xl">
    ...
    <form action="{{ route('users.store') }}" method="POST" class="soft-card p-4 lg:p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6 mb-4 lg:mb-6">
            ...
            <div>
                ...
                <div class="space-y-3">
                    <label class="flex items-center p-3 rounded-xl border-2 border-gray-200 hover:border-gray-400 transition-all cursor-pointer {{ old('role') === 'admin' ? 'bg-gray-50 border-gray-600' : '' }}">
                        <input type="radio" 
                               name="role" 
                               value="admin" 
                    ...
                    <label class="flex items-center p-3 rounded-xl border-2 border-gray-200 hover:border-gray-400 transition-all cursor-pointer {{ old('role') === 'kasir' ? 'bg-gray-50 border-gray-600' : '' }}">
                        <input type="radio" 
                               name="role" 
                               value="kasir" 
            ...
            <div>
                ...
                <div class="space-y-3">
                    <label class="flex items-center p-3 rounded-xl border-2 border-gray-200 hover:border-gray-400 transition-all cursor-pointer {{ old('status') === 'aktif' ? 'bg-gray-50 border-gray-600' : '' }}">
                        <input type="radio" 
                               name="status" 
                               value="aktif" 
                    ...
                    <label class="flex items-center p-3 rounded-xl border-2 border-gray-200 hover:border-gray-400 transition-all cursor-pointer {{ old('status') === 'tidak_aktif' ? 'bg-gray-50 border-gray-600' : '' }}">
                        <input type="radio" 
                               name="status" 
                               value="tidak_aktif" 
