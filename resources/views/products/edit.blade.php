...
<div class="max-w-3xl">
    ...
    <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg border border-gray-200 p-6">
        @csrf
        @method('PUT')
        ...
        <div class="mb-6">
            ...
            @else
                <div class="mt-4">
                    <p class="text-sm text-gray-600 mb-2">Gambar Saat Ini:</p>
                    <div class="w-32 h-32 bg-gray-200 rounded flex items-center justify-center border border-gray-300">
