    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            /* --- PERUBAHAN DI SINI --- */
            width: 48mm;      /* Lebar area cetak */
            margin-left: 3mm; /* Menggeser seluruh konten ke kanan 5mm */
            padding: 2mm;     /* Jarak dalam konten */
            /* ------------------------- */
        ...
        @media print {
            body {
                /* Saat diprint, pastikan margin tetap berlaku */
                margin-left: 3mm; 
                padding: 2mm;
            }
        }
